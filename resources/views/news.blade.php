            ...
            <div class="container">
                <div class="row g-4 align-items-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{route('newsRead.show', $featurednews->id)}}" class="btn-load-more">BACA SELENGKAPNYA</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 news-item" style="display: {{ $loop->index < 8 ? 'block' : 'none' }};" data-aos="fade-up" data-aos-delay="{{ 250 + ($index * 50) }}">
                        <div class="card h-100 news-card">
                            <img src="{{ asset($data->image) }}" class="card-img-top" alt="{{ $data->title }}">
                            <div class="card-body">
                                <h5 class="card-title mb-2">{{ $data->title }}</h5>
                                <p class="card-text text-muted mb-3">{{ Str::limit ($data->description,80) }}</p>
                                <div class="card-actions">
                                    <a href="{{route('newsRead.show', $data->id)}}" class="stretched-link small text-decoration-none">Baca selengkapnya</a>
